...
# We want to produce local timestamp, then replace dot with a random number from 0 t0 10.
    ...
    def parse(self, response):
        for page_idx in xrange(1, 100):
            ...
            page_url = "http://weibo.com/rmrb?is_search=0&visible=0&is_tag=0&profile_ftype=1&page="+str(page_idx)+"#"+ts
           ...
           #print web_page
            ...
            #http://weibo.com/p/aj/v6/mblog/mbloglist?ajwvr=6&domain=100206&nick=%E5%A4%B4%E6%9D%A1%E6%96%B0%E9%97%BB&pre_page=1&page=1&max_id=&end_id=3885415314331468&pagebar=0&filtered_min_id=&pl_name=Pl_Official_MyProfileFeed__26&id=1002061618051664&script_uri=/rmrb&feed_type=0&domain_op=100206&__rnd=1442372461187
            ...
            for i in xrange(0, 2):
                ...
                try:
                    ...
                    continue
                print 100 * '"'
                dynamic_url = "http://weibo.com/p/aj/v6/mblog/mbloglist?ajwvr=6&domain=" + domain_id + "&page="+ str(page_idx) +"&pre_page="+ str(page_idx) + "&end_id=" + end_id +"&pagebar=" + str(i) + "&pl_name=Pl_Official_MyProfileFeed__26&id=" + page_id + "&script_uri=/p/rmrb&feed_type=0&domain_op=" +domain_id + "&__rnd=" + local_ts
                print dynamic_url
